...
public class CadatroDeAdiministradorParaAdiministradorTela {
     private  static AdiministradorCRUDRepositorio  adiministradorCRUDRepositorio =  new AdiministradorCRUDRepositorio();
     private  static CadastraAdiministradorServico cadastraAdiministradorServico =  new CadastraAdiministradorServico(adiministradorCRUDRepositorio);
     public  static void  exibir(Scanner s) throws InterruptedException, NoSuchAlgorithmException {
         ClearUtil.LimparTerminal(0);
         ColoresUtil.printYellow("=============== Cadastrar Adiministrador =============== ");
         ...
         cadastraAdiministradorServico.cadastrarAdiministrador(new AdiministradorModelo(nome,cpf,telefone,email,senha));
    }
}
